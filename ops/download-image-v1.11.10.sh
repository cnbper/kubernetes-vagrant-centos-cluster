...
k8s_modules=("kube-apiserver-amd64:v1.11.10" "kube-controller-manager-amd64:v1.11.10" "kube-scheduler-amd64:v1.11.10" "kube-proxy-amd64:v1.11.10" "pause:3.1" "etcd-amd64:3.2.18" "coredns:1.1.3")
